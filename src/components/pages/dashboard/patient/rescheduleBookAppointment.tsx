...
interface BookAppointmentProps {
  ...
  existingAppointmentData?: Partial<AppointmentData>;
...
export default function BookAppointment({
  ...
  const [formData, setFormData] = useState<AppointmentData>({
    ...
    consultedType: existingAppointmentData?.consultedType || "",
    reasonForVisit: existingAppointmentData?.reasonForVisit || "",
    symptoms: existingAppointmentData?.symptoms || "",
    previousVisit: existingAppointmentData?.previousVisit || "",
    emergencyContact: existingAppointmentData?.emergencyContact || "",
    emergencyPhone: existingAppointmentData?.emergencyPhone || "",
    paymentMethod: existingAppointmentData?.paymentMethod || "",
    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            {isReschedule
              ? "Update your appointment details with"
        ...
        {isSuccess ? (
          <div className="text-center py-8">
            ...
            <p className="text-gray-600 mb-4">
              Your appointment with {doctor.name} has been{" "}
              {isReschedule ? "rescheduled" : "confirmed"} for{" "}
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      disabled={!formData.consultedType}
                    >
                      <SelectTrigger
                        className={
                    ...
                    <CardContent className="space-y-2">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium capitalize">
                          {formData.consultationType || "Not selected"}
                        </span>
                      </div>
