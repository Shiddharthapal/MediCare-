...
const userDetailsSchema = new mongoose.Schema({
  ...
  appointments: {
    ...
    // Changed from [String] to [appointmentDataSchema]
    default: []
    // Optional: set default empty array
  },
  payment: {
...
const adminStore = mongoose.models.AdminStore || mongoose.model("AdminStore", adminStoreSchema);

export { adminStore as a };
